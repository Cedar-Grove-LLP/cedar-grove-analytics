...
export const WORKBOOKS = Object.freeze([
  ...
  { key: 'vanloon-2026', attorney: 'Colin van Loon', userId: 'colin-van-loon', year: 2026,
    spreadsheetId: '1vEXzO-9HVaqnrqPPhnwxra1Mm_lQ4sapFlymCsXchjg', tabRange: "'{tab}'!A1:AF400" },
  { key: 'agate-2026', attorney: 'Nick Agate', userId: 'nick-agate', year: 2026,
    spreadsheetId: '1_OShAn1_oHjKCNnLkvgDBFHbn44a-4IBjYDa-nyzlCk', tabRange: "'{tab}'!A1:AF400" },
  { key: 'skrodzka-2026', attorney: 'Martyna Skrodzka', userId: 'martyna-skrodzka', year: 2026,
    spreadsheetId: '1kx9EdqcflSgg6mKcHHSM-potVNqPcaoB5gtuu1-wTcI', tabRange: "'{tab}'!A1:AF400" },
  { key: 'wilson-2026', attorney: 'Paige Wilson', userId: 'paige-wilson', year: 2026,
    spreadsheetId: '1FHm83YubcJXjJnL0LXekzT55yf3Na7iKgTs_hqEUQd4', tabRange: "'{tab}'!A1:AF400" },
  { key: 'levin-2026', attorney: 'Michael Levin', userId: 'michael-levin', year: 2026,
    spreadsheetId: '1eR2tdKrsK-Dtrk5flAcKqWRL5z-PqpGhhwuIoW1Sy7w', tabRange: "'{tab}'!A1:AF400" },
  { key: 'popkin-2026', attorney: 'David Popkin', userId: 'david-popkin', year: 2026,
    spreadsheetId: '1arHZ9BINt5DBcwAxw8cfQnITNzr8Y3BeW8LQdIqFLFw', tabRange: "'{tab}'!A1:AF400" },
  { key: 'manning-2026', attorney: 'Molly Manning', userId: 'molly-manning', year: 2026,
    spreadsheetId: '1Nq--CGYW-umbxi_bQCrNlnj-z95ovnXYnX7mgLgUNhk', tabRange: "'{tab}'!A1:AF400" },
  { key: 'mcclure-2026', attorney: 'Sam McClure', userId: 'sam-mcclure', year: 2026,
    spreadsheetId: '1OVphjUzgUwwpRnmp0G53iyNYCQmRZJKCcQXNXJIjOSo', tabRange: "'{tab}'!A1:AF400" },
  { key: 'ohta-2026', attorney: 'Michael Ohta', userId: 'michael-ohta', year: 2026,
    spreadsheetId: '1MDoJ48EuESyNuCcg3ofBCQ1rk-G2PnR06bJI4hnIk-w', tabRange: "'{tab}'!A1:AF400" },
  { key: 'uscanga-2026', attorney: 'Valery Uscanga', userId: 'valery-uscanga', year: 2026,
    spreadsheetId: '1d8PZeic2-PVZQmE9sIbkUwkN4dJu6RlzNdgdNZH-ovQ', tabRange: "'{tab}'!A1:AF400" },
  { key: 'munoz-2026', attorney: 'Munoz', userId: 'munoz', year: 2026,
    spreadsheetId: '1JpE6XBH7LYL0yDITQPT1bx7s4uqd6BkoggMml9rxF2I', tabRange: "'{tab}'!A1:AF400" },

  // ---- 2025 books ---------------------------------------------------------
  { key: 'vanloon-2025', attorney: 'Colin van Loon', userId: 'colin-van-loon', year: 2025,
    spreadsheetId: '1W_XyxSVtOO2Rx0hSRRkp7E1imn-nrEX1YmeW_OOGCH0', tabRange: "'{tab}'!A1:AF400" },
  { key: 'mcclure-2025', attorney: 'Sam McClure', userId: 'sam-mcclure', year: 2025,
    spreadsheetId: '14cWOVYhL7HOvY9Iek3fW5J_Zqwh_1gczvG8cofc4ytY', tabRange: "'{tab}'!A1:AF400" },
  { key: 'ohta-2025', attorney: 'Michael Ohta', userId: 'michael-ohta', year: 2025,
    spreadsheetId: '14RqTnP6l47eVndacpdCYfvE-1-Z_sV4qUYLAghyvKxE', tabRange: "'{tab}'!A1:AF400" },
  { key: 'uscanga-2025', attorney: 'Valery Uscanga', userId: 'valery-uscanga', year: 2025,
    spreadsheetId: '1arvyvuzZMyVvTjelA4mLvTYs2EYxrQ9oDQAI6_VB8kw', tabRange: "'{tab}'!A1:AF400" },
  ...
  { key: 'weekes-2025', attorney: 'Miika Weekes', userId: 'miika-weekes', year: 2025,
    spreadsheetId: '1_Xw8lR2nUKPC4UoCoEdtX6KkRfJrrXkQBUOf6_cBpnc', tabRange: "'{tab}'!A1:AF400" },
  { key: 'duble-2025', attorney: 'Andrew Duble', userId: 'andrew-duble', year: 2025,
    spreadsheetId: '1a-cvokVdIcSm9D5vGFLFcxxt4O0QqfR_nNSKjh3Taxg', tabRange: "'{tab}'!A1:AF400" },
  { key: 'popkin-2025', attorney: 'David Popkin', userId: 'david-popkin', year: 2025,
    spreadsheetId: '1-MqUVw3_HHzDvAaebt5d_u9IFH7nx_eeCqEYWdyqCvQ', tabRange: "'{tab}'!A1:AF400" },
  { key: 'agate-2025', attorney: 'Nick Agate', userId: 'nick-agate', year: 2025,
    spreadsheetId: '1oXQbRb8fJE8OSSI9TGS593xWhBOGbyNSGlFYtSjMP7A', tabRange: "'{tab}'!A1:AF400" },

  // ---- firm-wide books ------------------------------------------------------
  { key: 'firm-2026', attorney: null, userId: null, year: 2026,
    spreadsheetId: '1Qkqc4zsqMzP9lN4qTYiDpdJEbQAWQq88j3p23SVxNq8', tabRange: "'{tab}'!A1:AF400" },
  { key: 'firm-2025', attorney: null, userId: null, year: 2025,
    spreadsheetId: '1IJwvMOcE2dmneUrQ2hx634NxM7Utvr9HpfV8EUxSzrE', tabRange: "'{tab}'!A1:AF400" },
]);
